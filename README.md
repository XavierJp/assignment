...
I am Xavier from the Solutions Engineering team. Let me try to explain the two following concepts :

An index is a collection of item on which you can perform queries, and obtain search results.

A record is basically an item that you can retreive, using Algolia search angine. Each record has attributes (define in JSON), which can be used for searching, filtering, displaying, ranking.
...
The best type of metrics to include in a custom ranking depends on your business. For instance a restaurant search experience would tend to value restaurant with the best review, over a strict textual relevance.


For more informations you can have a look at the Algolia documentation's definitions. If you do not understand a concept, or you want to discuss about the best custom ranking metric to choose do not hesitate to come back to me and eventually schedule a call.
...
I am Xavier from the Solutions Engineering team. I am indeed really sorry to hear that but here at Algolia we highly appreciate customer feedback. I will immediately notify the UX team in charge of the dashboard.
...
To answer your question, Algolia is doing everything it can to ensure that the integration is as smooth as possible :

As a new customer, you can schedule a demo where our engineers will mock up an integration to you website to help visualize the way algolia could change your website's searching experience :
